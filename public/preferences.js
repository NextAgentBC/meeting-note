...
export const ZH = {
  ...
  "Update": "更新",
  "Meeting Note has been updated. Refresh to use the new version.": "Meeting Note 已更新，刷新一下就能用上新版本。",
  "Time zone": "时区",
  "Sign out": "退出登录",
...
export const FR = {
  ...
  "Meeting Note has been updated. Refresh to use the new version.": "Meeting Note a été mis à jour. Actualisez pour utiliser la nouvelle version.",
